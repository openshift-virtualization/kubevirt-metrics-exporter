...
var (
	podBlockDesc = prometheus.NewDesc(
		"kubevirt_block_io_latency_seconds",
	...
	systemBlockDesc = prometheus.NewDesc(
		"kubevirt_system_block_io_latency_seconds",
